...
export default function CartBox({ cartVisible, setCartVisible }) {
  ...
  const cartStyles =
    "overflow-auto right-0 top-[4.5rem] fixed bottom-0 left-0 md:left-auto w-full md:w-[400px] md:shadow-lg p-4 bg-white transition-transform duration-500 translate-x-full";
